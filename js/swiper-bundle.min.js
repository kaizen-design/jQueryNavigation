...
var Swiper = function () {
  ...
  function f(e, t) {
    return void 0 === t && (t = ""), _toConsumableArray(e.children).filter(e => e.matches(t));
  }
  function g(e) {
    try {
  ...
  const ee = {
      ...
      events: {
        attachEvents: function () {
          ...
          e.onTouchStart = R.bind(e), e.onTouchMove = q.bind(e), e.onTouchEnd = F.bind(e), e.onDocumentTouchStart = U.bind(e), t.cssMode && (e.onScroll = W.bind(e)), e.onClick = _.bind(e), e.onLoad = j.bind(e), K(e, "on");
        },
  ...
  const he = [function (e) {
    ...
    r("beforeInit", () => {
      ...
      if (void 0 === s.passedParams.virtual.slides) {
        const t = _toConsumableArray(s.slidesEl.children).filter(e => e.matches(`.${s.params.slideClass}, swiper-slide`));
    ...
    function p() {
      ...
      if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
        ...
        if (s.dynamicBullets && (n = S(i[0], t.isHorizontal() ? "width" : "height", !0), c.forEach(e => {
          ...
          var _e$classList4;
          const t = _toConsumableArray(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => `${s.bulletActiveClass}${e}`)).map(e => "string" == typeof e && e.includes(" ") ? e.split(" ") : e).flat();
          (_e$classList4 = e.classList).remove.apply(_e$classList4, _toConsumableArray(t));
        }), c.length > 1) i.forEach(e => {
          var _e$classList5, _e$classList6;
          const i = y(e);
          i === a ? (_e$classList5 = e.classList).add.apply(_e$classList5, _toConsumableArray(s.bulletActiveClass.split(" "))) : t.isElement && e.setAttribute("part", "bullet"), s.dynamicBullets && (i >= o && i <= p && (_e$classList6 = e.classList).add.apply(_e$classList6, _toConsumableArray(`${s.bulletActiveClass}-main`.split(" "))), i === o && d(e, "prev"), i === p && d(e, "next"));
        });else {
          var _e$classList7;
          const e = i[a];
          if (e && (_e$classList7 = e.classList).add.apply(_e$classList7, _toConsumableArray(s.bulletActiveClass.split(" "))), t.isElement && i.forEach((e, t) => {
            ...
            for (let e = o; e <= p; e += 1) {
              var _i$e$classList;
              i[e] && (_i$e$classList = i[e].classList).add.apply(_i$e$classList, _toConsumableArray(`${s.bulletActiveClass}-main`.split(" ")));
            }
            d(e, "prev"), d(t, "next");
          }
        }
