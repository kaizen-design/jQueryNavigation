...
!function (t, e) {
  ...
  const t = new Map(),
    ...
    g = (t, e = [], i = t) => "function" == typeof t ? t.apply(void 0, _toConsumableArray(e)) : i,
    _ = (t, e, n = !0) => {
  ...
  const B = t => {
    ...
    z = {
      ...
      children: (t, e) => {
        var _ref2;
        return (_ref2 = []).concat.apply(_ref2, _toConsumableArray(t.children)).filter(t => t.matches(e));
      },
      parents(t, e) {
        const i = [];
  ...
  class qi extends W {
    ...
    show() {
      ...
      if (!N.trigger(this._element, xi, t).defaultPrevented) {
        if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) for (const t of (_ref3 = []).concat.apply(_ref3, _toConsumableArray(document.body.children))) {
          var _ref3;
          N.on(t, "mouseover", h);
        }
    ...
    _completeHide(t) {
      if (!N.trigger(this._element, Ci, t).defaultPrevented) {
        if ("ontouchstart" in document.documentElement) for (const t of (_ref4 = []).concat.apply(_ref4, _toConsumableArray(document.body.children))) {
          var _ref4;
          N.off(t, "mouseover", h);
        }
  ...
  class Jn extends H {
    ...
    _maybeSanitize(t) {
      return this._config.sanitize ? function (t, e, i, _ref5) {
        if (!t.length) return t;
        if (i && "function" == typeof i) return i(t);
        const n = new window.DOMParser().parseFromString(t, "text/html"),
          s = (_ref5 = []).concat.apply(_ref5, _toConsumableArray(n.body.querySelectorAll("*")));
        for (const t of s) {
          var _ref6;
          const i = t.nodeName.toLowerCase();
          ...
          const n = (_ref6 = []).concat.apply(_ref6, _toConsumableArray(t.attributes)),
            s = [].concat(e["*"] || [], e[i] || []);
  ...
  class cs extends W {
    ...
    show() {
      ...
      if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), N.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i), i.classList.add(es), "ontouchstart" in document.documentElement) for (const t of (_ref7 = []).concat.apply(_ref7, _toConsumableArray(document.body.children))) {
        var _ref7;
        N.on(t, "mouseover", h);
      }
      this._queueCallback(() => {
    ...
    hide() {
      if (this._isShown() && !N.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
        if (this._getTipElement().classList.remove(es), "ontouchstart" in document.documentElement) for (const t of (_ref8 = []).concat.apply(_ref8, _toConsumableArray(document.body.children))) {
          var _ref8;
          N.off(t, "mouseover", h);
        }
